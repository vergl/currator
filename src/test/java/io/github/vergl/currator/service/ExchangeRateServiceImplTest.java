...
public class ExchangeRateServiceImplTest {
    ...
    public void setUp() {
        ...
        Mockito.lenient().when(exchangeRateRepository.findByDateAndCurrency(newYear2020, Currency.USD))
    ...
    public void getExchangeRateByDateAndCurrencyShouldReturnExchangeRate() {
        ...
        Assertions.assertAll(
                ...
                () -> Assertions.assertEquals(Currency.EUR, result.getBaseCurrency()),
                () -> Assertions.assertEquals(1.3, result.getRate())
        );

        Mockito.verify(exchangeRateRepository).findByDateAndCurrency(newYear2020, Currency.USD);
    }
